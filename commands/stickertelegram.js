...
try {
    ...
    console.log('Sharp module not available, sticker features will be limited');
    sharp = null;
}
    ...
    try {
        if (!sharp) {
            await sock.sendMessage(chatId, {
                text: '❌ Sorry, sticker features are not available due to missing dependencies.'
            });
            return;
        }
        ...
        console.error('Error in sticker telegram command:', error);
        await sock.sendMessage(chatId, {
            text: '❌ An error occurred while processing the sticker command.'
        });
    }
}
