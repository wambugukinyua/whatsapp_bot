...
const qrCommand = require('./commands/qr_complete');
...
async function handleMessages(sock, messageUpdate, printLog) {
    ...
    try {
        ...
        if (userMessage.startsWith('.')) {
            console.log(`📝 Command used in ${isGroup ? 'group' : 'private'}: "${userMessage}" from ${senderId}`);
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.qr'):
                await qrCommand(sock, chatId, message);
                break;
